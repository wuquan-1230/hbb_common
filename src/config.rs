...
map.insert("password".to_string(), "Fzzy123.".to_string());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["124.71.187.17"];
pub const RS_PUB_KEY: &str = "OeVuKk5nlHiXp+APNn0Y3pC1Iwpwn44JGqrQCsWqmBw=";

pub const RENDEZVOUS_PORT: i32 = 8116;
pub const RELAY_PORT: i32 = 8117;
